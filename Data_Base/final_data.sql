...
('4', 'bandage', 3, 'healing', 'skill', 'apply and heal 3 hp', 3, 0, 0, 0, 0, 0),
('5', 'glove', 3, 'attack', 'skill', 'delas 3 damage points to the opponent', 0, 3, 0, 0, 0, 0),
...
('11', 'sword', 2, 'attack', 'weapon', 'deals 2 damage to the opponent', 0, 2, 0, 0, 0, 0),
('12', 'fear', 2, 'attack', 'hypnosis', 'deals 2 damage to the opponent', 0, 2, 0, 0, 0, 0),
('13', 'sharp stick', 1, 'attack', 'weapon', 'deals 1 damage to the opponent', 0, 1, 0, 0, 0, 0),
('14', 'sleep', 3, 'special', 'hypnosis', 'skips enemy turn', 0, 0, 0, 0, 0, 0),
('15', 'confusion', 2, 'attack', 'skill', 'deals 2 damage to the opponent', 0, 2, 0, 0, 0, 0),
...
('20', 'dandelion', 3, 'attack', 'skill', 'deals 3 damage to the opponent', 0, 3, 0, 0, 0, 0),
('21', 'seashell', 1, 'attack', 'skill', 'deals 1 damage to opponent', 0, 1, 0, 0, 0, 0),
('22', 'rabbit foot', 1, 'attack', 'skill', 'deals 2 damage to the opponent', 0, 2, 0, 0, 0, 0),
('23', 'wedding ring', 3, 'attack', 'skill', 'deals 3 damage to the opponent', 0, 3, 0, 0, 0, 0),
('24', 'wishbone', 2, 'attack', 'skill', 'deals 3 damage to the opponent', 0, 3, 0, 0, 0, 0);
